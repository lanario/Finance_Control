...
/**
 * Página de callback para confirmação de email e OAuth do fluxo pessoal.
 * O Supabase redireciona aqui após confirmação de email ou login com Google.
 * Estabelece a sessão e redireciona para o dashboard.
 */
export default function AuthCallbackPessoalPage() {
